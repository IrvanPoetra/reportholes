    ...
    <div class="about-us">
        <div class="container">
            <div class="row" data-aos="fade-up" data-aos-duration="500">
                <div class="col-md-12">
                    <img src="<?php echo base_url() ;?>assets/images/about.jpg" alt="about-bg" class="thumbnail image">
                    <h3>About Us</h3>
                    <p>Reportholes adalah portal pelaporan jalan rusak yang dikembangkan oleh Reportholes Indonesia yang didukung oleh Jasa marga. Melayani perbaikan jalan rusak di seluruh daerah di Indonesia terutaam Pulau Jawa dan Bali. Kami memberikan pelayanan perbaikan jalan gratis untuk semua orang.
                    </p>
                </div>
            </div>
        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mx-auto">
                            ...
                            <ul class="list-unstyled">
                                ...
                                <li>
                                    <a href="#!">Policy for Reporter </a>
                                </li>
                                <li>
                                    <a href="#!">Policy for Watcher </a>
                                </li>
                                <li>
                                    <a href="#!">Reporter Security  </a>
                                </li>
                                <li>
