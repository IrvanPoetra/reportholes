        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 col-12 buttons">
                    <!-- Buttons -->
                    <a href="report" class="btn btn-warning">Report now</a>
                    <!-- Buttons End-->
                </div>
            </div>
        </div>
    ...
    <section id="services">
        ...
        <div class="container">
            ...
            <div class="row main-content" data-aos="fade-up" data-aos-duration="500">
                <div class="col-sm-12">
                    <h3>Jalan raya Sidoarjo-Mojokerto</h3>
                </div>
                ...
                <div class="col-xs-12 col-md-12 col-lg-4">
                    <img class="img-responsive career-img" src="<?php echo base_url() ;?>assets/images/service-1.jpg" alt="service-2">
                </div>
            </div>
            <!-- First Row Ended -->
            ...
            <div class="row main-content" data-aos="fade-up" data-aos-duration="500">
                <div class="col-sm-12">
                    <h3>Jalan Ir. Soekarno Malang</h3>
                </div>
                <div class="col-xs-12 col-md-12 col-lg-4">
                    <img class="img-responsive career-img" src="<?php echo base_url() ;?>assets/images/service-2.jpg" alt="service-2">
                </div>
                <div class="col-xs-12 col-md-12 col-lg-8">
                    <div class="contant">
                        <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and...</p>
            ...
            <div class="row main-content" data-aos="fade-up" data-aos-duration="500">
                ...
                <div class="col-xs-12 col-md-12 col-lg-4">
                    <img class="img-responsive career-img" src="<?php echo base_url() ;?>assets/images/service-3.jpg" alt="service-2">
                </div>
            </div>
            <!-- Third Row Ended -->
            <div class="row main-content" data-aos="fade-up" data-aos-duration="500">
                <div class="col-sm-12">
                    <h3>Jalan Kenari Pekalongan</h3>
                </div>
                <div class="col-xs-12 col-md-12 col-lg-4">
                    <img class="img-responsive career-img" src="<?php echo base_url() ;?>assets/images/service-2.jpg" alt="service-2">
                </div>
