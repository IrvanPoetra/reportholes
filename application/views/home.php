    ...
    <section class="section-1">
        <div class="jumbotron d-flex align-items-center">
            ...
            <div class="container content">
                <h1>Perusahaan Layanan Perbaikan Jalan Rusak Yang Didukung Pemerintah RI</h1>
                <h2>Cepat, Terpercaya, Dan berkualitas</h2>
                <p>Ratusan jalan rusak tiap bulannya, tanpa ada bantuan gerak pemerintah setempat yang cepat kita hadir untuk membantu masalah kerusakan jalan di daerah manapun secepat mungkin.</p>
                <p><a href="report" class="btn btn-success">report now</a><a href="projects" class="btn btn-default">view our projects</a></p>
            </div>
            <!--container-fluid end-->
        </div>
    </section>
                ...
                <div class="col-lg-4 col-md-12 col-xs-12">
                    <div class="card">
                        <div class="card-block block-1">
                            <h3 class="card-title"><a href="services.php">road damages</a></h3>
                        </div>
                        <p class="card-text">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and...</p>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-12 col-xs-12">
                    <div class="card">
                        <div class="card-block block-2">
                            <h3 class="card-title"><a href="services.php">bridge reconstruction</a></h3>
                        </div>
                        <p class="card-text">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and...</p>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-12 col-xs-12">
                    <div class="card">
                        <div class="card-block block-3">
                            <h3 class="card-title"><a href="services.php">consulting</a></h3>
                        </div>
                        <p class="card-text">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and...</p>
                    </div>
                </div>
        ...
        <div class="container">
            ...
            <div class="row align-items-center" data-aos="fade-up" data-aos-duration="500">
                <div class="col-lg-5 col-md-12 left-side">
                    <!-- 1st col -->
                    <figure class="figure">
                        <img src="<?php echo base_url() ;?>assets/images/about-bg.jpeg" class="figure-img img-fluid" alt="Hasil kerja jalan pandugo raya." >
                ...
                <div class="col-lg-7 col-md-12 right-side">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <!-- Buttons -->
                            <a href="projects" class="btn btn-warning">Other Projects</a>
                            <!-- Buttons End-->
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row" data-aos="fade-up" data-aos-duration="500">
                    ...
                    <div id="accordion" class="accordion">
                        <div class="card">
                            <div class="card-header" data-toggle="collapse" href="#collapseOne">
                                <a class="card-title">
                                    Menangani Berbagai Jenis Kerusakan Jalan
                                </a>
                            </div>
                            ...
                            <div class="card-header collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo">
                                <a class="card-title">
                                    Pekerjaan Cepat Dengan Kualitas Terbaik
                                </a>
                            </div>
                            ...
                            <div class="card-header collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseThree">
                                <a class="card-title">
                                    Mencakup seluruh daerah di Indonesia terutama Jawa dan Bali
                                </a>
                            </div>
                ...
                <div class="col-lg-5 col-md-12">
                    <figure class="figure">
                        <img src="<?php echo base_url() ;?>assets/images/section-2-image.jpg" class="figure-img img-fluid" alt="A generic square placeholder image with rounded corners in a figure.">
                    </figure>
                </div>
            </div>
        </div>
            ...
            <div class="row"  data-aos="fade-up" data-aos-duration="600">
                <div class="col-lg-6 col-md-12 left-slid">
                    <div class="videoWrapper">
                        ...
                        <iframe width="100%" src="https://www.youtube.com/embed/m_pW6YCkX74" frameborder="0" allowfullscreen></iframe>
                    </div>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mx-auto">
                            ...
                            <ul class="list-unstyled">
                                ...
                                <li>
                                    <a href="support.php">Report Damages</a>
                                </li>
                            </ul>
...
>>>>>>> f080919183869dc26e10d291dc6140e5e5a0be97
